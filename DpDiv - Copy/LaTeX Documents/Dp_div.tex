...
\newpage
	...
	\begin{equation}
	D_p(f_0,f_1)=1-2\int_{x_1} ... \int_{x_8} \frac{f_0(\textbf{x}){f_1}(\textbf{x})}{{f_0}(\textbf{x})+{f_1}(\textbf{x})}dx_1... dx_8
	\end{equation}
	
	For dimensions 2-8, there is full overlap between $f_0(\textbf{x})$ and $f_1(\textbf{x})$:
